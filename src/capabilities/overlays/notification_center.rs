...
use crate::capabilities::primitives::button::{Button, ButtonVariant};
use crate::capabilities::primitives::empty_state::EmptyState;
use crate::capabilities::primitives::icon::Icon;
use crate::capabilities::primitives::icon_source::IconSource;
...
impl NotificationVariant {
    ...
    fn color(&self, theme: &crate::capabilities::foundation::theme::Theme) -> Hsla {
        match self {
                        ...
                        |d| {
                            d.child(
                                Button::new("mark-all-read", "Mark all read")
                                    ...
                                    .size(crate::capabilities::primitives::button::ButtonSize::Sm)
            ...
            .when(is_empty, |d| {
                d.child(
                    EmptyState::new("notification-empty", "No notifications")
                        ...
                        .size(crate::capabilities::primitives::empty_state::EmptyStateSize::Sm)
                        .py(px(32.0)),
                )
            })
            .when(!is_empty, |d| {
