...
pub fn init(cx: &mut App) {
    if !crate::capabilities::foundation::initialization::begin(cx, "inline-edit") {
        return;
    }
    cx.bind_keys([
...
impl InlineEditState {
    ...
    fn offset_to_utf16(&self, offset: usize) -> usize {
        crate::capabilities::controls::text_util::offset_to_utf16(&self.edit_value, offset)
    }

    fn range_to_utf16(&self, range: &Range<usize>) -> Range<usize> {
        crate::capabilities::controls::text_util::range_to_utf16(&self.edit_value, range)
    }

    fn range_from_utf16(&self, range_utf16: &Range<usize>) -> Range<usize> {
        crate::capabilities::controls::text_util::range_from_utf16(&self.edit_value, range_utf16)
    }
