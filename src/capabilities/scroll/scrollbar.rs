...
impl Scrollbar {
    ...
    fn get_thumb_color(&self, theme: &crate::capabilities::foundation::theme::Theme) -> Hsla {
        theme.tokens.muted_foreground.opacity(0.6)
    }

    fn get_track_color(&self, theme: &crate::capabilities::foundation::theme::Theme) -> Hsla {
        theme.tokens.muted.opacity(0.3)
    }

    fn get_hover_thumb_color(&self, theme: &crate::capabilities::foundation::theme::Theme) -> Hsla {
